...
@section('pagetitle','Activities and Events')
@section('pagesubtitle','')
@section('breadcrumb')
  <ol class="breadcrumb">
	    <li><a href="{{ route('admin.home')  }}"><i class="fa fa-dashboard"></i> Home</a></li>
	    <li class="active">Activities and Events</li>
   </ol>
@stop
    ...
    <div class="box">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                {!! Form::open(['method' => 'POST', 'url' => (empty($data) ? route('activity.store'): route('activity.update',$data->id))  , 'class' => 'form-vertical']) !!}
